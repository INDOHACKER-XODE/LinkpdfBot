class Presets(object):
    START_TXT = "<b>Hello.. {}</b> 👋\n\n<i>Send me any valid link to convert to Pdf\n\nMade With ❤ By @UpdateBots1</i>"
    PROCESS_TXT = "<code>Processing your link..</code>"
    INVALID_LINK_TXT = "<b>Invalid link</b>\n\n<i>Please send me a valid link</i>"
    UPLOAD_TXT = "<b>Uploading your file..\n\nMade With ❤ By @UpdateBots1</b>"
    ERROR_TXT = "<b>URL Error</b>\n\n<i>Unable to create a Pdf with this URL.\nTry again with a valid one..</i>"
    CAPTION_TXT = "{}\n\n<b>Credits:</b><a href='https://github.com/INDOHACKER-XODE'><b> @YuiHirasawauserbot</b></a>"
